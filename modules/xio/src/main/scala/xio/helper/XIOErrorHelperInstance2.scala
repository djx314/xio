...
object XIOErrorHelperInstance2 {
  def errorCompat1[P <: xio.nat.error.NatEither, E1, Input, Out](
    e1: xio.ErrorContent[E1, P] => zio.ZIO[Input, P, Out],
    u: xio.XError1[E1]
  ): zio.ZIO[Input, P, Out] = e1(new xio.ErrorContentImpl(u.sureRight))
  def errorCompat2[P <: xio.nat.error.NatEither, E1, E2, Input, Out](
    e1: xio.ErrorContent[E1, P] => zio.ZIO[Input, P, Out],
    e2: xio.ErrorContent[E2, P] => zio.ZIO[Input, P, Out],
    u: xio.XError2[E1, E2]
  ): zio.ZIO[Input, P, Out] = u.either.fold(ii1 => errorCompat1(e1, ii1), ii2 => e2(new xio.ErrorContentImpl(ii2)))
  def errorCompat3[P <: xio.nat.error.NatEither, E1, E2, E3, Input, Out](
    e1: xio.ErrorContent[E1, P] => zio.ZIO[Input, P, Out],
    e2: xio.ErrorContent[E2, P] => zio.ZIO[Input, P, Out],
    e3: xio.ErrorContent[E3, P] => zio.ZIO[Input, P, Out],
    u: xio.XError3[E1, E2, E3]
  ): zio.ZIO[Input, P, Out] = u.either.fold(ii1 => errorCompat2(e1, e2, ii1), ii2 => e3(new xio.ErrorContentImpl(ii2)))
  def errorCompat4[P <: xio.nat.error.NatEither, E1, E2, E3, E4, Input, Out](
    e1: xio.ErrorContent[E1, P] => zio.ZIO[Input, P, Out],
    e2: xio.ErrorContent[E2, P] => zio.ZIO[Input, P, Out],
    e3: xio.ErrorContent[E3, P] => zio.ZIO[Input, P, Out],
    e4: xio.ErrorContent[E4, P] => zio.ZIO[Input, P, Out],
    u: xio.XError4[E1, E2, E3, E4]
  ): zio.ZIO[Input, P, Out] = u.either.fold(ii1 => errorCompat3(e1, e2, e3, ii1), ii2 => e4(new xio.ErrorContentImpl(ii2)))
  def errorCompat5[P <: xio.nat.error.NatEither, E1, E2, E3, E4, E5, Input, Out](
    e1: xio.ErrorContent[E1, P] => zio.ZIO[Input, P, Out],
    e2: xio.ErrorContent[E2, P] => zio.ZIO[Input, P, Out],
    e3: xio.ErrorContent[E3, P] => zio.ZIO[Input, P, Out],
    e4: xio.ErrorContent[E4, P] => zio.ZIO[Input, P, Out],
    e5: xio.ErrorContent[E5, P] => zio.ZIO[Input, P, Out],
    u: xio.XError5[E1, E2, E3, E4, E5]
  ): zio.ZIO[Input, P, Out] = u.either.fold(ii1 => errorCompat4(e1, e2, e3, e4, ii1), ii2 => e5(new xio.ErrorContentImpl(ii2)))
  def errorCompat6[P <: xio.nat.error.NatEither, E1, E2, E3, E4, E5, E6, Input, Out](
    ...
    e4: xio.ErrorContent[E4, P] => zio.ZIO[Input, P, Out],
    e5: xio.ErrorContent[E5, P] => zio.ZIO[Input, P, Out],
    e6: xio.ErrorContent[E6, P] => zio.ZIO[Input, P, Out],
    u: xio.XError6[E1, E2, E3, E4, E5, E6]
  ): zio.ZIO[Input, P, Out] = u.either.fold(ii1 => errorCompat5(e1, e2, e3, e4, e5, ii1), ii2 => e6(new xio.ErrorContentImpl(ii2)))
  def errorCompat7[P <: xio.nat.error.NatEither, E1, E2, E3, E4, E5, E6, E7, Input, Out](
    ...
    e5: xio.ErrorContent[E5, P] => zio.ZIO[Input, P, Out],
    e6: xio.ErrorContent[E6, P] => zio.ZIO[Input, P, Out],
    e7: xio.ErrorContent[E7, P] => zio.ZIO[Input, P, Out],
    u: xio.XError7[E1, E2, E3, E4, E5, E6, E7]
  ): zio.ZIO[Input, P, Out] = u.either.fold(ii1 => errorCompat6(e1, e2, e3, e4, e5, e6, ii1), ii2 => e7(new xio.ErrorContentImpl(ii2)))
  def errorCompat8[P <: xio.nat.error.NatEither, E1, E2, E3, E4, E5, E6, E7, E8, Input, Out](
    ...
    e6: xio.ErrorContent[E6, P] => zio.ZIO[Input, P, Out],
    e7: xio.ErrorContent[E7, P] => zio.ZIO[Input, P, Out],
    e8: xio.ErrorContent[E8, P] => zio.ZIO[Input, P, Out],
    u: xio.XError8[E1, E2, E3, E4, E5, E6, E7, E8]
  ): zio.ZIO[Input, P, Out] = u.either.fold(ii1 => errorCompat7(e1, e2, e3, e4, e5, e6, e7, ii1), ii2 => e8(new xio.ErrorContentImpl(ii2)))
  def errorCompat9[P <: xio.nat.error.NatEither, E1, E2, E3, E4, E5, E6, E7, E8, E9, Input, Out](
    ...
    e7: xio.ErrorContent[E7, P] => zio.ZIO[Input, P, Out],
    e8: xio.ErrorContent[E8, P] => zio.ZIO[Input, P, Out],
    e9: xio.ErrorContent[E9, P] => zio.ZIO[Input, P, Out],
    u: xio.XError9[E1, E2, E3, E4, E5, E6, E7, E8, E9]
  ): zio.ZIO[Input, P, Out] = u.either.fold(ii1 => errorCompat8(e1, e2, e3, e4, e5, e6, e7, e8, ii1), ii2 => e9(new xio.ErrorContentImpl(ii2)))
  def errorCompat10[P <: xio.nat.error.NatEither, E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, Input, Out](
    ...
    e8: xio.ErrorContent[E8, P] => zio.ZIO[Input, P, Out],
    e9: xio.ErrorContent[E9, P] => zio.ZIO[Input, P, Out],
    e10: xio.ErrorContent[E10, P] => zio.ZIO[Input, P, Out],
    u: xio.XError10[E1, E2, E3, E4, E5, E6, E7, E8, E9, E10]
  ): zio.ZIO[Input, P, Out] = u.either.fold(ii1 => errorCompat9(e1, e2, e3, e4, e5, e6, e7, e8, e9, ii1), ii2 => e10(new xio.ErrorContentImpl(ii2)))
  def errorCompat11[P <: xio.nat.error.NatEither, E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, Input, Out](
    ...
    e9: xio.ErrorContent[E9, P] => zio.ZIO[Input, P, Out],
    e10: xio.ErrorContent[E10, P] => zio.ZIO[Input, P, Out],
    e11: xio.ErrorContent[E11, P] => zio.ZIO[Input, P, Out],
    u: xio.XError11[E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11]
  ): zio.ZIO[Input, P, Out] = u.either.fold(ii1 => errorCompat10(e1, e2, e3, e4, e5, e6, e7, e8, e9, e10, ii1), ii2 => e11(new xio.ErrorContentImpl(ii2)))
  def errorCompat12[P <: xio.nat.error.NatEither, E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, Input, Out](
    ...
    e10: xio.ErrorContent[E10, P] => zio.ZIO[Input, P, Out],
    e11: xio.ErrorContent[E11, P] => zio.ZIO[Input, P, Out],
    e12: xio.ErrorContent[E12, P] => zio.ZIO[Input, P, Out],
    u: xio.XError12[E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12]
  ): zio.ZIO[Input, P, Out] = u.either.fold(ii1 => errorCompat11(e1, e2, e3, e4, e5, e6, e7, e8, e9, e10, e11, ii1), ii2 => e12(new xio.ErrorContentImpl(ii2)))
  def errorCompat13[P <: xio.nat.error.NatEither, E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, E13, Input, Out](
    ...
    e11: xio.ErrorContent[E11, P] => zio.ZIO[Input, P, Out],
    e12: xio.ErrorContent[E12, P] => zio.ZIO[Input, P, Out],
    e13: xio.ErrorContent[E13, P] => zio.ZIO[Input, P, Out],
    u: xio.XError13[E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, E13]
  ): zio.ZIO[Input, P, Out] = u.either.fold(ii1 => errorCompat12(e1, e2, e3, e4, e5, e6, e7, e8, e9, e10, e11, e12, ii1), ii2 => e13(new xio.ErrorContentImpl(ii2)))
  def errorCompat14[P <: xio.nat.error.NatEither, E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, E13, E14, Input, Out](
    ...
    e12: xio.ErrorContent[E12, P] => zio.ZIO[Input, P, Out],
    e13: xio.ErrorContent[E13, P] => zio.ZIO[Input, P, Out],
    e14: xio.ErrorContent[E14, P] => zio.ZIO[Input, P, Out],
    u: xio.XError14[E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, E13, E14]
  ): zio.ZIO[Input, P, Out] = u.either.fold(ii1 => errorCompat13(e1, e2, e3, e4, e5, e6, e7, e8, e9, e10, e11, e12, e13, ii1), ii2 => e14(new xio.ErrorContentImpl(ii2)))
  def errorCompat15[P <: xio.nat.error.NatEither, E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, E13, E14, E15, Input, Out](
    ...
    e13: xio.ErrorContent[E13, P] => zio.ZIO[Input, P, Out],
    e14: xio.ErrorContent[E14, P] => zio.ZIO[Input, P, Out],
    e15: xio.ErrorContent[E15, P] => zio.ZIO[Input, P, Out],
  ...
  def errorCompat16[P <: xio.nat.error.NatEither, E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, E13, E14, E15, E16, Input, Out](
    ...
    e14: xio.ErrorContent[E14, P] => zio.ZIO[Input, P, Out],
    e15: xio.ErrorContent[E15, P] => zio.ZIO[Input, P, Out],
    e16: xio.ErrorContent[E16, P] => zio.ZIO[Input, P, Out],
  ...
  def errorCompat17[P <: xio.nat.error.NatEither, E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, E13, E14, E15, E16, E17, Input, Out](
    ...
    e15: xio.ErrorContent[E15, P] => zio.ZIO[Input, P, Out],
    e16: xio.ErrorContent[E16, P] => zio.ZIO[Input, P, Out],
    e17: xio.ErrorContent[E17, P] => zio.ZIO[Input, P, Out],
  ...
  def errorCompat18[P <: xio.nat.error.NatEither, E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, E13, E14, E15, E16, E17, E18, Input, Out](
    ...
    e16: xio.ErrorContent[E16, P] => zio.ZIO[Input, P, Out],
    e17: xio.ErrorContent[E17, P] => zio.ZIO[Input, P, Out],
    e18: xio.ErrorContent[E18, P] => zio.ZIO[Input, P, Out],
  ...
  def errorCompat19[P <: xio.nat.error.NatEither, E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, E13, E14, E15, E16, E17, E18, E19, Input, Out](
    ...
    e17: xio.ErrorContent[E17, P] => zio.ZIO[Input, P, Out],
    e18: xio.ErrorContent[E18, P] => zio.ZIO[Input, P, Out],
    e19: xio.ErrorContent[E19, P] => zio.ZIO[Input, P, Out],
  ...
  def errorCompat20[P <: xio.nat.error.NatEither, E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, E13, E14, E15, E16, E17, E18, E19, E20, Input, Out](
    ...
    e18: xio.ErrorContent[E18, P] => zio.ZIO[Input, P, Out],
    e19: xio.ErrorContent[E19, P] => zio.ZIO[Input, P, Out],
    e20: xio.ErrorContent[E20, P] => zio.ZIO[Input, P, Out],
  ...
  def errorCompat21[P <: xio.nat.error.NatEither, E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, E13, E14, E15, E16, E17, E18, E19, E20, E21, Input, Out](
    ...
    e19: xio.ErrorContent[E19, P] => zio.ZIO[Input, P, Out],
    e20: xio.ErrorContent[E20, P] => zio.ZIO[Input, P, Out],
    e21: xio.ErrorContent[E21, P] => zio.ZIO[Input, P, Out],
  ...
  def errorCompat22[P <: xio.nat.error.NatEither, E1, E2, E3, E4, E5, E6, E7, E8, E9, E10, E11, E12, E13, E14, E15, E16, E17, E18, E19, E20, E21, E22, Input, Out](
    ...
    e20: xio.ErrorContent[E20, P] => zio.ZIO[Input, P, Out],
    e21: xio.ErrorContent[E21, P] => zio.ZIO[Input, P, Out],
    e22: xio.ErrorContent[E22, P] => zio.ZIO[Input, P, Out],
