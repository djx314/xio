...
object Test1 {
  ...
  type Ei2 = NatEitherFirst.Type[Item3]#Next[Item4]#Next[Item4]#Next[Item3]#Next[Item3]
  ...
  def main(arr: Array[String]): Unit = {
    ...
    val item5Either: NatEitherContent[NatEitherFirst.Type[Item3]#Next[Item4]] = NatEitherContent[Ei2](new Item3)
