...
object XIOCodegen {
  ...
  val filePath1 = Paths.get(".", "a05-XIO", "xio-implicit", "src", "main", "scala", "xio", "nat", "has", "XHasProjection.scala")
  val filePath2 = Paths.get(".", "a05-XIO", "xio-implicit", "src", "main", "scala", "xio", "nat", "error", "XErrorProjection.scala")
