...
class NatReversePlusPositive[N1Tail <: Nat, N1Head, N2 <: Nat](val tail: NatReversePlus[N2, N1Tail]) extends NatReversePlus[N2, NatPositive[N1Tail, N1Head]] {
  override type PluI = NatPositive[N1Tail#InnerPlus[N2], N1Head]
  override def plus(t1: NatPositive[N1Tail, N1Head], t2: N2): NatPositive[N1Tail#InnerPlus[N2], N1Head] = new NatPositive(tail = tail.plus(t1.tail, t2), head = t1.head)
