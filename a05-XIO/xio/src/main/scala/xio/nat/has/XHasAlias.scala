...
trait XHasAlias {
  ...
  object XHas2 {
    def apply[T1, T2](_1: T1, _2: T2): XHas2[T1, T2]  = new nat.has.NatPositive(tail = XHas1(_1), head = _2)
    def fromTuple[T1, T2](i: (T1, T2)): XHas2[T1, T2] = apply(_1 = i._1, _2 = i._2)
  }
  object XHas3 {
    def apply[T1, T2, T3](_1: T1, _2: T2, _3: T3): XHas3[T1, T2, T3] = new nat.has.NatPositive(tail = XHas2(_1, _2), head = _3)
    def fromTuple[T1, T2, T3](i: (T1, T2, T3)): XHas3[T1, T2, T3]    = apply(_1 = i._1, _2 = i._2, _3 = i._3)
  }
  object XHas4 {
    def apply[T1, T2, T3, T4](_1: T1, _2: T2, _3: T3, _4: T4): XHas4[T1, T2, T3, T4] = new nat.has.NatPositive(tail = XHas3(_1, _2, _3), head = _4)
    def fromTuple[T1, T2, T3, T4](i: (T1, T2, T3, T4)): XHas4[T1, T2, T3, T4]        = apply(_1 = i._1, _2 = i._2, _3 = i._3, _4 = i._4)
  }
  object XHas5 {
    def apply[T1, T2, T3, T4, T5](_1: T1, _2: T2, _3: T3, _4: T4, _5: T5): XHas5[T1, T2, T3, T4, T5] = new nat.has.NatPositive(tail = XHas4(_1, _2, _3, _4), head = _5)
